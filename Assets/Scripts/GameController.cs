...
public class GameController : MonoBehaviour
{
  //  public GameObject Obj;
    ...
    public List<IntPair> dataList = new List<IntPair>();
    ...
    {
        Singleton.instance.homeScreenController.OpenHomeScreen();
    }
    ...
    public void Init()
    {
        Singleton.instance.jsonData.StoreData(dataList);
    ...
    public IEnumerator CheckGameEnd()
    {
        ...
        if (GameEndCounter == ((rowCount * columnCount) / 2))
        {
            ...
            Singleton.instance.homeScreenController.Init();
            Close();
        }
    }
